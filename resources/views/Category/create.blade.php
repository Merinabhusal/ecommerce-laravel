...
<input type="text" name="priority" placeholder="Enter Priority" class="w-full rounded-lg">
     ...
     <input type="file" name="photopath" class="w-full rounded-lg mt-4 p-2 border border-gray-500" >
        ...
        @enderror
            ...
            <button type="submit" class="bg-blue-600 text-white mx-2 px-4 py-2 rounded-lg">Add Category</button>
            <a href="{{route('category.index')}}" class="bg-red-600 text-white mx-2 px-10 py-2 rounded-lg">Exit</a>
        </div>
    </form>
</div>
