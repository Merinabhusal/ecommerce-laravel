...
<div>
<form action="{{route('featureditem.store')}}"method ="POST" enctype="multipart/form-data">
@csrf
<input type="text" name="priority" placeholder="Enter Priority" class="w-full rounded-lg">
     ...
     <input type="file" name="photopath" class="w-full rounded-lg mt-4 p-2 border border-gray-500" >
        ...
        @enderror
            ...
            <a href="{{route('featureditem.index')}}" class="bg-red-600 text-white mx-2 px-10 py-2 rounded-lg">Exit</a>
        </div>
    </form>
</div>
