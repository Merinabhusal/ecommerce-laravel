...
@endphp
        ...
        <ul>
            ...
            <h2 class="text-gray-900">Quantity:{{ $item->quantity}}</h2>
           <p class="text-gray-900 ">Rs{{ $item->product->price }}</p>
            <p class="text-gray-700">Description:{{ $item->product->description}}</p>
